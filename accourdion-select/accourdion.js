document.addEventListener('DOMContentLoaded', function() {
    ...
    innerCheckboxes.forEach(function(checkbox) {
        checkbox.addEventListener('change', function() {
            ...
            var allChecked = Array.from(document.querySelectorAll(`input[data-parent='${parentId}']`)).every(cb => cb.checked);
            var anyChecked = Array.from(document.querySelectorAll(`input[data-parent='${parentId}']`)).some(cb => cb.checked);
